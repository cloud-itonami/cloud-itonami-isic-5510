# Operator Quickstart — Community Accommodation Operations

Shortest path from clone to a verified local dry-run for **ISIC 5510** (`cloud-itonami-isic-5510`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5510.git
cd cloud-itonami-isic-5510
```
...
- Blueprint governor key: `hospitality-governor`
- Likely source path: `hospitalityops.governor.cljc`
