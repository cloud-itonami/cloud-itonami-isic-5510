...
- human sign-off for :high/:safety-critical robot actions (e.g. operating in guest rooms, near guests or handling guest belongings)
...
## Operating states
intake : reserve : check-in : serve : check-out : audit
