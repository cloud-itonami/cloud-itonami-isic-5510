...
`cloud-itonami-5510` is an OSS open-business blueprint for community accommodation operations, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Hospitality Governor remains independent of the advisor.
